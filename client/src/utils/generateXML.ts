        ...
        .ele('Employee')
          ...
          .ele('SalaryData')
            ...
            .ele('SocialContributions')
              .ele('HealthCare').txt(((results.totalImposable + results.totalSocial) * 0.028).toFixed(2)).up()
              .ele('HealthCash').txt(((results.totalImposable + results.totalSocial) * 0.0025).toFixed(2)).up()
              .ele('Pension').txt(((results.totalImposable + results.totalSocial) * 0.08).toFixed(2)).up()
