...
export default function Home() {
  ...
  // Close sidebar on route/view change (mobile)
  useEffect(() => {
    ...
    <>
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`mb-0.5 flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-[13px] font-medium transition-all ${
                active
      ...
      <div className="px-3 pt-2">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-[13px] font-medium text-slate-400 transition-all hover:bg-white/5 hover:text-slate-200"
        >
            ...
            employees.map((emp) => {
              ...
              return (
                <div
                  ...
                  className={`group flex cursor-pointer items-center gap-2.5 rounded-lg px-2.5 py-2.5 transition-all ${
                    active ? "bg-indigo-600/15" : "hover:bg-white/5"
                  }`}
                >
                  <div
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside
        className={`
          fixed inset-y-0 left-0 z-50 flex w-[280px] flex-col bg-[#0c0f1a] text-slate-300
          transition-transform duration-300 ease-in-out
          lg:static lg:w-[260px] lg:translate-x-0 lg:transition-none
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* ── Mobile top bar ── */}
        <header className="flex h-14 flex-shrink-0 items-center gap-3 border-b border-slate-200/60 bg-white px-4 lg:hidden">
          <button
          ...
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-indigo-600">
              <Calculator className="h-3.5 w-3.5 text-white" strokeWidth={2.5} />
            </div>
            <span className="text-sm font-semibold text-slate-900">LuxPayroll</span>
          </div>
